(() => {
  ...
  const guides = {
    customer: ['Tu tarjeta, paso a paso', [
      ...
      ['Tu cuenta y Renace', 'En “Mi cuenta” puedes cambiar tu PIN. Si lo olvidaste, pide ayuda al administrador en el mostrador: te dará un PIN temporal que tendrás que cambiar al entrar. Los enlaces de Instagram, TikTok, menú y ubicación están debajo de tu tarjeta QR.']
    ]],
    ...
    admin: ['Tu guía de administración', [
      ['Las métricas', '“Clientes” muestra las cuentas activas. “Sellos hoy” muestra las visitas registradas hoy. “Cafés disponibles” cuenta las recompensas que los clientes tienen listas para canjear, no el inventario de bebidas. “Cafés canjeados” muestra las recompensas ya entregadas.'],
      ...
      ['Actividad y exportación', 'El historial muestra fecha, cliente, movimiento, motivo y quién lo registró, en páginas de 6. Filtra por fechas, cliente, movimiento o empleado. Los botones “Exportar” descargan un CSV de los resultados visibles para abrirlo en una hoja de cálculo; no exportan automáticamente todas las páginas.'],
